...
export class ImageProcessingService {
	...
	private async generateThumbnails(
		...
		const [small, medium, large] = await Promise.all([
			this.generateThumbnail(buffer, this.thumbnailSizes.small, format, quality),
			this.generateThumbnail(buffer, this.thumbnailSizes.medium, format, quality),
			this.generateThumbnail(buffer, this.thumbnailSizes.large, format, quality),
		]);
